 ...
 * @returns {Array<pigpio.GenericWaveStep>} Spaces.
 */
 ...
 * @returns {Array<pigpio.GenericWaveStep>} Pulses.
 */
const createPulse = (us, { gpio, frequency }) => {
  // Microseconds
  const cycle = 1000 / frequency;
 ...
 * @param {Array<number>} code - Code to send.
 * @param {object} options - Options object.
 * @param {number} options.frequency - Sub-carrier frequency in kHz.
 * @throws {Error}
 */
 ...
 *
 * @param {number} gpio - The GPIO number.
 * @param {Array<number> | Array<Array<number>>} codeOrCodes - Code to send.
 * @param {object} options - Options object.
 * @param {number} [options.frequency] - Sub-carrier frequency in kHz.
